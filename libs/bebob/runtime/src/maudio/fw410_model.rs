...
impl LevelCtlOperation<Fw410PhysInputProtocol> for PhysInputCtl {
...
impl LrBalanceCtlOperation<Fw410PhysInputProtocol> for PhysInputCtl {
...
impl LevelCtlOperation<Fw410AuxSourceProtocol> for AuxSourceCtl {
...
impl LevelCtlOperation<Fw410AuxOutputProtocol> for AuxOutputCtl {
...
impl LevelCtlOperation<Fw410PhysOutputProtocol> for PhysOutputCtl {
...
impl SelectorCtlOperation<Fw410PhysOutputProtocol> for PhysOutputCtl {
    ...
    const VAL_LABELS: &'static [&'static str] = &["mixer-output", "aux-output-1/2"];
}

#[derive(Default)]
struct HeadphoneCtl;

impl LevelCtlOperation<Fw410HeadphoneProtocol> for HeadphoneCtl {
    const LEVEL_NAME: &'static str = "headphone-volume";
    const PORT_LABELS: &'static [&'static str] = &["headphone-1", "headphone-2"];
}

impl SelectorCtlOperation<Fw410HeadphoneProtocol> for HeadphoneCtl {
...
impl SelectorCtlOperation<Fw410SpdifOutputProtocol> for SpdifInputCtl {
    const SELECTOR_NAME: &'static str = "S/PDIF-input-source";
    const SELECTOR_LABELS: &'static [&'static str] = &["S/PDIF-input-1/2"];
    const VAL_LABELS: &'static [&'static str] = &["coaxial-input-1/2", "optical-input-1/2"];
}
